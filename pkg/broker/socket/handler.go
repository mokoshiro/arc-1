...
import (
	...
	"github.com/Bo0km4n/arc/pkg/broker/h3"
	"github.com/Bo0km4n/arc/pkg/broker/infra/db"
...
func RoomNotification(m *msg.RoomNotificationRequest) (*msg.RoomNotificationResponse, error) {
	return &msg.RoomNotificationResponse{}, nil
}
