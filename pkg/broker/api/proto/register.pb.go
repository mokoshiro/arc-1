...
// source: pkg/broker/api/proto/register.proto
...
func init() {
	proto.RegisterFile("pkg/broker/api/proto/register.proto", fileDescriptor_424c431e6e63db39)
}
...
func (c *brokerClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
func (c *brokerClient) GetMemberByRadius(ctx context.Context, in *GetMemberByRadiusRequest, opts ...grpc.CallOption) (*GetMemberByRadiusResponse, error) {
...
var _Tracker_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/broker/api/proto/register.proto",
}
